...
do 
  echo $z 
  ssh -i ~/.ssh/cms_aws_3.pem ubuntu@$z sudo rm /home/ubuntu/cc/cloud-crawler/logs/worker.log
  ssh -i ~/.ssh/cms_aws_3.pem ubuntu@$z sudo touch /home/ubuntu/cc/cloud-crawler/logs/worker.log
